...
const Footer = () => {
  ...
  return (
    <div>
      <footer className="footer sm:p-7 md:py-12 md:px-36 bg-primary-300 text-amber-400/80 w-screen">
        <aside>
          <svg
            width="50"
            height="50"
          ...
          <h1 className="sm:text-lg md:text-2xl font-bold mb-1">
      ...
      <footer className="footer sm:p-7 md:py-4 md:px-36 border-t bg-primary-300 text-amber-400/80 border-base-100/40">
        <aside className="items-center grid-flow-col">
          <p>
            © All right reserved by Suvidha Foundation (Suvidha Mahila Mandal)
          </p>
        </aside>
