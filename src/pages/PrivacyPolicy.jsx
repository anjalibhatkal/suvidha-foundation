...
import privacy from "/images/pages/privacy.jpg";
        ...
        <div className="relative">
          ...
          <div className="bg-gradient-to-b from-base-100/50 to-[#FDB777] py-20 px-24">
            ...
            <p className="text-xl py-5 tracking-wider text-center">
              ...
              provide to us about yourself (“Personal Information”) on our
              website.
              <br />
              This policy describes the types of personal information we
              collect, how we may use that information and with whom we may
              share it when you visit our site or use our services (collectively
              the “Services”).
              <br /> Our Privacy Policy also describes the measures we take to
              protect the security of the information. <br />
              In addition, we describe the choices you can make about how we use
              the information you provide to us. We also tell you how you can
              reach us to update your contact information, remove your name from
              our mailing lists, or answer any questions you may have about our
              privacy practices.
              <br />
              We maintain full confidentiality of all donors and contributors on
              our mailing and email lists, which will neither be sold to nor
              exchanged with any other organization or commercial enterprise,
              and we honour donors' opt-out choices in our mail, email, phone
            ...
            <div className="py-4">
              ...
              <p className="text-xl tracking-wider pt-2">
                ...
                to provide additional information as well, such as your postal
            ...
            <div className="py-4">
              ...
              <p className="text-xl tracking-wider pt-2">
                ...
                your contact information in our records so we can contact you to
                provide ChildFund India's program information and information on
            ...
            <div className="py-4">
              ...
              <p className="text-xl tracking-wider pt-2">
                ...
                a safe and secure environment for online donations.
              </p>
            </div>
            ...
            <div className="py-4">
              ...
              <p className="text-xl tracking-wider pt-2">
                ...
                card number is used only for that particular transaction and is
                not stored. If you allow us to store your credit card or bank
                information for future use such as recurring donation, such
                information will be stored by the payment services financial
                institution. Suvidha Mahila Mandal only uses financial
                institution that adheres to the industry standards for storing
                such information.
              </p>
            </div>
            <div className="py-4">
            ...
            <div className="py-4">
              ...
              <p className="text-xl tracking-wider pt-2">
                ...
                information.
                <br /> We maintain administrative, technical and physical
                safeguards to protect against unauthorized disclosure, use,
                alteration or destruction of the personal information in our
                possession.
                <br /> All online transactions are done on a secure server.
                <br />
                When you provide credit card information to make a donation, we
                use the industry standard for Internet security ― Secure Socket
                Layer (SSL) technology ― to help protect the information you
                provide.
                <br /> This Internet encryption standard scrambles data as it
                travels from your computer to our server. Please note, however,
                that perfect security does not exist on the Internet. You'll
                know that you're in a secure area of our Site when a “lock” icon
                appears on your screen and the “http” portion of our URL address
                changes to “https.” The “s” stands for “secure.”
              </p>
            </div>
            <div className="py-4">
              <h2 className="text-primary-300 text-4xl text-center font-bold tracking-wide transition-transform hover:scale-110 pb-4 border-t-2 border-spacing-y-20 border-primary-200 pt-8">
              ...
              <p className="text-xl tracking-wider pt-2">
                ...
                Policy. You may reach out to us if you have any queries about
                any changes made to our practices.
              </p>
            </div>
          </div>
        </div>
